...
exports.SnapshotApi = exports.SnapshotApiApiKeys = void 0;
...
// ===============================================
var SnapshotApiApiKeys;
(function (SnapshotApiApiKeys) {
    SnapshotApiApiKeys[SnapshotApiApiKeys["Token Authentication"] = 0] = "Token Authentication";
})(SnapshotApiApiKeys = exports.SnapshotApiApiKeys || (exports.SnapshotApiApiKeys = {}));
var SnapshotApi = /** @class */ (function () {
    function SnapshotApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(SnapshotApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(SnapshotApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(SnapshotApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    SnapshotApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    SnapshotApi.prototype.setApiKey = function (key, value) {
        this.authentications[SnapshotApiApiKeys[key]].apiKey = value;
    };
    Object.defineProperty(SnapshotApi.prototype, "username", {
    ...
    Object.defineProperty(SnapshotApi.prototype, "password", {
    ...
    SnapshotApi.prototype.addInterceptor = function (interceptor) {
     ...
     */
    SnapshotApi.prototype.snapshotsDelete = function (snapshotId, pretty, depth, xContractNumber, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/snapshots/{snapshotId}'
                ...
                if (snapshotId === null || snapshotId === undefined) {
                    throw new Error('Required parameter snapshotId was null or undefined when calling snapshotsDelete.');
                }
                if (pretty !== undefined) {
                        ...
                        if (error) {
                            ...
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                ...
                                switch (response.statusCode) {
                                    case SnapshotApi.BAD_GATEWAY:
                                    case SnapshotApi.SERVICE_UNAVAILABLE:
                                    case SnapshotApi.GATEWAY_TIMEOUT:
                                        backoffTime = SnapshotApi.waitTime;
                                        break;
                                    case SnapshotApi.TOO_MANY_REQUESTS:
                                        if (response.headers['retry-after'] != null) {
                                            backoffTime = response.headers['retry-after'];
                                        }
                                        else {
     ...
     * @param xContractNumber Users having more than 1 contract need to provide contract number, against which all API requests should be executed
     */
    SnapshotApi.prototype.snapshotsFindById = function (snapshotId, pretty, depth, xContractNumber, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                // verify required parameter 'snapshotId' is not null or undefined
                if (snapshotId === null || snapshotId === undefined) {
                    throw new Error('Required parameter snapshotId was null or undefined when calling snapshotsFindById.');
                }
                if (pretty !== undefined) {
                    localVarQueryParameters['pretty'] = models_1.ObjectSerializer.serialize(pretty, "boolean");
                }
     ...
     * @param xContractNumber Users having more than 1 contract need to provide contract number, against which all API requests should be executed
     */
    SnapshotApi.prototype.snapshotsGet = function (pretty, depth, xContractNumber, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/snapshots';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
                // give precedence to 'application/json'
                ...
                apiCallFunction = function (resolve, reject) {
                    request_1.default(localVarRequestOptions, function (error, response, body) {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "Snapshots");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
     ...
     * @param xContractNumber Users having more than 1 contract need to provide contract number, against which all API requests should be executed
     */
    SnapshotApi.prototype.snapshotsPatch = function (snapshotId, snapshot, pretty, depth, xContractNumber, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                // verify required parameter 'snapshotId' is not null or undefined
                if (snapshotId === null || snapshotId === undefined) {
                    throw new Error('Required parameter snapshotId was null or undefined when calling snapshotsPatch.');
                }
                // verify required parameter 'snapshot' is not null or undefined
                if (snapshot === null || snapshot === undefined) {
                    throw new Error('Required parameter snapshot was null or undefined when calling snapshotsPatch.');
                }
                if (pretty !== undefined) {
                    localVarQueryParameters['pretty'] = models_1.ObjectSerializer.serialize(pretty, "boolean");
                }
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(snapshot, "SnapshotProperties")
                };
                authenticationPromise = Promise.resolve();
                if (this.authentications['Basic Authentication'].username && this.authentications['Basic Authentication'].password) {
                    authenticationPromise = authenticationPromise.then(function () { return _this.authentications['Basic Authentication'].applyToRequest(localVarRequestOptions); });
     ...
     * @param xContractNumber Users having more than 1 contract need to provide contract number, against which all API requests should be executed
     */
    SnapshotApi.prototype.snapshotsPut = function (snapshotId, snapshot, pretty, depth, xContractNumber, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                // verify required parameter 'snapshotId' is not null or undefined
                if (snapshotId === null || snapshotId === undefined) {
                    throw new Error('Required parameter snapshotId was null or undefined when calling snapshotsPut.');
                }
                // verify required parameter 'snapshot' is not null or undefined
                if (snapshot === null || snapshot === undefined) {
                    throw new Error('Required parameter snapshot was null or undefined when calling snapshotsPut.');
                }
                if (pretty !== undefined) {
                    localVarQueryParameters['pretty'] = models_1.ObjectSerializer.serialize(pretty, "boolean");
                }
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(snapshot, "Snapshot")
                };
                authenticationPromise = Promise.resolve();
                if (this.authentications['Basic Authentication'].username && this.authentications['Basic Authentication'].password) {
                    authenticationPromise = authenticationPromise.then(function () { return _this.authentications['Basic Authentication'].applyToRequest(localVarRequestOptions); });
    ...
    SnapshotApi.prototype.sleep = function (seconds) {
        var e = new Date().getTime() + (seconds * 1000);
        while (new Date().getTime() <= e) { }
    };
    SnapshotApi.prototype.waitForCompletion = function (requestId, timeout, initialWait, scaleup, maxRetries) {
    ...
    SnapshotApi.BAD_GATEWAY = 502;
    SnapshotApi.SERVICE_UNAVAILABLE = 503;
    SnapshotApi.GATEWAY_TIMEOUT = 504;
    SnapshotApi.TOO_MANY_REQUESTS = 429;
    SnapshotApi.maxRetries = 3;
    SnapshotApi.waitTime = 10;
    SnapshotApi.maxWaitTime = 2000;
    return SnapshotApi;
}());
