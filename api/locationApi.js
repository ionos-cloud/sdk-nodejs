...
exports.LocationApi = exports.LocationApiApiKeys = void 0;
...
(function (LocationApiApiKeys) {
    LocationApiApiKeys[LocationApiApiKeys["Token Authentication"] = 0] = "Token Authentication";
})(LocationApiApiKeys = exports.LocationApiApiKeys || (exports.LocationApiApiKeys = {}));
var LocationApi = /** @class */ (function () {
    function LocationApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(LocationApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(LocationApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(LocationApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    LocationApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    LocationApi.prototype.setApiKey = function (key, value) {
        this.authentications[LocationApiApiKeys[key]].apiKey = value;
    };
    Object.defineProperty(LocationApi.prototype, "username", {
    ...
    Object.defineProperty(LocationApi.prototype, "password", {
    ...
    LocationApi.prototype.addInterceptor = function (interceptor) {
     ...
     */
    LocationApi.prototype.locationsFindByRegionId = function (regionId, pretty, depth, xContractNumber, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/locations/{regionId}'
                ...
                if (regionId === null || regionId === undefined) {
                    throw new Error('Required parameter regionId was null or undefined when calling locationsFindByRegionId.');
                }
                if (pretty !== undefined) {
                ...
                apiCallFunction = function (resolve, reject) {
                    request_1.default(localVarRequestOptions, function (error, response, body) {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "Locations");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                ...
                                switch (response.statusCode) {
                                    case LocationApi.BAD_GATEWAY:
                                    case LocationApi.SERVICE_UNAVAILABLE:
                                    case LocationApi.GATEWAY_TIMEOUT:
     ...
     * @param xContractNumber Users having more than 1 contract need to provide contract number, against which all API requests should be executed
     */
    LocationApi.prototype.locationsFindByRegionIdAndId = function (regionId, locationId, pretty, depth, xContractNumber, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/locations/{regionId}/{locationId}'
                    .replace('{' + 'regionId' + '}', encodeURIComponent(String(regionId)))
                ...
                // verify required parameter 'regionId' is not null or undefined
                if (regionId === null || regionId === undefined) {
                    throw new Error('Required parameter regionId was null or undefined when calling locationsFindByRegionIdAndId.');
                }
                // verify required parameter 'locationId' is not null or undefined
                if (locationId === null || locationId === undefined) {
                    throw new Error('Required parameter locationId was null or undefined when calling locationsFindByRegionIdAndId.');
                }
                if (pretty !== undefined) {
                    localVarQueryParameters['pretty'] = models_1.ObjectSerializer.serialize(pretty, "boolean");
                }
     ...
     * @param xContractNumber Users having more than 1 contract need to provide contract number, against which all API requests should be executed
     */
    LocationApi.prototype.locationsGet = function (pretty, depth, xContractNumber, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
    ...
    LocationApi.prototype.sleep = function (seconds) {
        var e = new Date().getTime() + (seconds * 1000);
        while (new Date().getTime() <= e) { }
    };
    LocationApi.prototype.waitForCompletion = function (requestId, timeout, initialWait, scaleup, maxRetries) {
    ...
    LocationApi.BAD_GATEWAY = 502;
    LocationApi.SERVICE_UNAVAILABLE = 503;
    LocationApi.GATEWAY_TIMEOUT = 504;
    LocationApi.TOO_MANY_REQUESTS = 429;
    LocationApi.maxRetries = 3;
    LocationApi.waitTime = 10;
    LocationApi.maxWaitTime = 2000;
    return LocationApi;
}());
