...
exports.ContractApi = exports.ContractApiApiKeys = void 0;
...
(function (ContractApiApiKeys) {
    ContractApiApiKeys[ContractApiApiKeys["Token Authentication"] = 0] = "Token Authentication";
})(ContractApiApiKeys = exports.ContractApiApiKeys || (exports.ContractApiApiKeys = {}));
var ContractApi = /** @class */ (function () {
    function ContractApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(ContractApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(ContractApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(ContractApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    ContractApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    ContractApi.prototype.setApiKey = function (key, value) {
        this.authentications[ContractApiApiKeys[key]].apiKey = value;
    };
    Object.defineProperty(ContractApi.prototype, "username", {
    ...
    Object.defineProperty(ContractApi.prototype, "password", {
    ...
    ContractApi.prototype.addInterceptor = function (interceptor) {
     ...
     */
    ContractApi.prototype.contractsGet = function (pretty, depth, xContractNumber, options) {
                        ...
                        if (error) {
                            ...
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                ...
                                switch (response.statusCode) {
                                    case ContractApi.BAD_GATEWAY:
                                    case ContractApi.SERVICE_UNAVAILABLE:
                                    case ContractApi.GATEWAY_TIMEOUT:
                                        backoffTime = ContractApi.waitTime;
                                        break;
                                    case ContractApi.TOO_MANY_REQUESTS:
                                        if (response.headers['retry-after'] != null) {
                                            backoffTime = response.headers['retry-after'];
                                        }
                                        else {
    ...
    ContractApi.prototype.sleep = function (seconds) {
        var e = new Date().getTime() + (seconds * 1000);
        while (new Date().getTime() <= e) { }
    };
    ContractApi.prototype.waitForCompletion = function (requestId, timeout, initialWait, scaleup, maxRetries) {
    ...
    ContractApi.BAD_GATEWAY = 502;
    ContractApi.SERVICE_UNAVAILABLE = 503;
    ContractApi.GATEWAY_TIMEOUT = 504;
    ContractApi.TOO_MANY_REQUESTS = 429;
    ContractApi.maxRetries = 3;
    ContractApi.waitTime = 10;
    ContractApi.maxWaitTime = 2000;
    return ContractApi;
}());
