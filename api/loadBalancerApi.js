...
exports.LoadBalancerApi = exports.LoadBalancerApiApiKeys = void 0;
...
// ===============================================
var LoadBalancerApiApiKeys;
(function (LoadBalancerApiApiKeys) {
    LoadBalancerApiApiKeys[LoadBalancerApiApiKeys["Token Authentication"] = 0] = "Token Authentication";
})(LoadBalancerApiApiKeys = exports.LoadBalancerApiApiKeys || (exports.LoadBalancerApiApiKeys = {}));
var LoadBalancerApi = /** @class */ (function () {
    function LoadBalancerApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(LoadBalancerApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(LoadBalancerApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(LoadBalancerApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    LoadBalancerApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    LoadBalancerApi.prototype.setApiKey = function (key, value) {
        this.authentications[LoadBalancerApiApiKeys[key]].apiKey = value;
    };
    Object.defineProperty(LoadBalancerApi.prototype, "username", {
    ...
    Object.defineProperty(LoadBalancerApi.prototype, "password", {
    ...
    LoadBalancerApi.prototype.addInterceptor = function (interceptor) {
     ...
     */
    LoadBalancerApi.prototype.datacentersLoadbalancersBalancednicsDelete = function (datacenterId, loadbalancerId, nicId, pretty, depth, xContractNumber, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/datacenters/{datacenterId}/loadbalancers/{loadbalancerId}/balancednics/{nicId}'
     ...
     * @param xContractNumber Users having more than 1 contract need to provide contract number, against which all API requests should be executed
     */
    LoadBalancerApi.prototype.datacentersLoadbalancersBalancednicsFindByNicId = function (datacenterId, loadbalancerId, nicId, pretty, depth, xContractNumber, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
     ...
     */
    LoadBalancerApi.prototype.datacentersLoadbalancersBalancednicsGet = function (datacenterId, loadbalancerId, pretty, depth, xContractNumber, offset, limit, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/datacenters/{datacenterId}/loadbalancers/{loadbalancerId}/balancednics'
                    .replace('{' + 'datacenterId' + '}', encodeURIComponent(String(datacenterId)))
                    .replace('{' + 'loadbalancerId' + '}', encodeURIComponent(String(loadbalancerId)));
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                ...
                apiCallFunction = function (resolve, reject) {
                    request_1.default(localVarRequestOptions, function (error, response, body) {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "BalancedNics");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
     ...
     * @param xContractNumber Users having more than 1 contract need to provide contract number, against which all API requests should be executed
     */
    LoadBalancerApi.prototype.datacentersLoadbalancersBalancednicsPost = function (datacenterId, loadbalancerId, nic, pretty, depth, xContractNumber, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
     ...
     * @param xContractNumber Users having more than 1 contract need to provide contract number, against which all API requests should be executed
     */
    LoadBalancerApi.prototype.datacentersLoadbalancersDelete = function (datacenterId, loadbalancerId, pretty, depth, xContractNumber, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/datacenters/{datacenterId}/loadbalancers/{loadbalancerId}'
                    .replace('{' + 'datacenterId' + '}', encodeURIComponent(String(datacenterId)))
                    .replace('{' + 'loadbalancerId' + '}', encodeURIComponent(String(loadbalancerId)));
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
     ...
     * @param xContractNumber Users having more than 1 contract need to provide contract number, against which all API requests should be executed
     */
    LoadBalancerApi.prototype.datacentersLoadbalancersFindById = function (datacenterId, loadbalancerId, pretty, depth, xContractNumber, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
                ...
                apiCallFunction = function (resolve, reject) {
                    request_1.default(localVarRequestOptions, function (error, response, body) {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "Loadbalancer");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
     ...
     * @param limit the maximum number of elements to return (use together with &lt;code&gt;offset&lt;/code&gt; for pagination)
     */
    LoadBalancerApi.prototype.datacentersLoadbalancersGet = function (datacenterId, pretty, depth, xContractNumber, offset, limit, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/datacenters/{datacenterId}/loadbalancers'
                    .replace('{' + 'datacenterId' + '}', encodeURIComponent(String(datacenterId)));
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
                ...
                apiCallFunction = function (resolve, reject) {
                    request_1.default(localVarRequestOptions, function (error, response, body) {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "Loadbalancers");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
     ...
     * @param xContractNumber Users having more than 1 contract need to provide contract number, against which all API requests should be executed
     */
    LoadBalancerApi.prototype.datacentersLoadbalancersPatch = function (datacenterId, loadbalancerId, loadbalancer, pretty, depth, xContractNumber, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(loadbalancer, "LoadbalancerProperties")
                };
                authenticationPromise = Promise.resolve();
                if (this.authentications['Basic Authentication'].username && this.authentications['Basic Authentication'].password) {
                    authenticationPromise = authenticationPromise.then(function () { return _this.authentications['Basic Authentication'].applyToRequest(localVarRequestOptions); });
     ...
     * @param xContractNumber Users having more than 1 contract need to provide contract number, against which all API requests should be executed
     */
    LoadBalancerApi.prototype.datacentersLoadbalancersPost = function (datacenterId, loadbalancer, pretty, depth, xContractNumber, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(loadbalancer, "Loadbalancer")
                };
                authenticationPromise = Promise.resolve();
                if (this.authentications['Basic Authentication'].username && this.authentications['Basic Authentication'].password) {
                    authenticationPromise = authenticationPromise.then(function () { return _this.authentications['Basic Authentication'].applyToRequest(localVarRequestOptions); });
     ...
     * @param xContractNumber Users having more than 1 contract need to provide contract number, against which all API requests should be executed
     */
    LoadBalancerApi.prototype.datacentersLoadbalancersPut = function (datacenterId, loadbalancerId, loadbalancer, pretty, depth, xContractNumber, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
    ...
    LoadBalancerApi.prototype.sleep = function (seconds) {
        var e = new Date().getTime() + (seconds * 1000);
        while (new Date().getTime() <= e) { }
    };
    LoadBalancerApi.prototype.waitForCompletion = function (requestId, timeout, initialWait, scaleup, maxRetries) {
    ...
    LoadBalancerApi.BAD_GATEWAY = 502;
    LoadBalancerApi.SERVICE_UNAVAILABLE = 503;
    LoadBalancerApi.GATEWAY_TIMEOUT = 504;
    LoadBalancerApi.TOO_MANY_REQUESTS = 429;
    LoadBalancerApi.maxRetries = 3;
    LoadBalancerApi.waitTime = 10;
    LoadBalancerApi.maxWaitTime = 2000;
