...
exports.IPBlocksApi = exports.IPBlocksApiApiKeys = void 0;
...
// ===============================================
var IPBlocksApiApiKeys;
(function (IPBlocksApiApiKeys) {
    IPBlocksApiApiKeys[IPBlocksApiApiKeys["Token Authentication"] = 0] = "Token Authentication";
})(IPBlocksApiApiKeys = exports.IPBlocksApiApiKeys || (exports.IPBlocksApiApiKeys = {}));
var IPBlocksApi = /** @class */ (function () {
    function IPBlocksApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(IPBlocksApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(IPBlocksApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(IPBlocksApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    IPBlocksApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    IPBlocksApi.prototype.setApiKey = function (key, value) {
        this.authentications[IPBlocksApiApiKeys[key]].apiKey = value;
    };
    Object.defineProperty(IPBlocksApi.prototype, "username", {
    ...
    Object.defineProperty(IPBlocksApi.prototype, "password", {
    ...
    IPBlocksApi.prototype.addInterceptor = function (interceptor) {
     ...
     */
    IPBlocksApi.prototype.ipblocksDelete = function (ipblockId, pretty, depth, xContractNumber, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/ipblocks/{ipblockId}'
                ...
                if (ipblockId === null || ipblockId === undefined) {
                    throw new Error('Required parameter ipblockId was null or undefined when calling ipblocksDelete.');
                }
                if (pretty !== undefined) {
                        ...
                        if (error) {
                            ...
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                ...
                                switch (response.statusCode) {
                                    case IPBlocksApi.BAD_GATEWAY:
                                    case IPBlocksApi.SERVICE_UNAVAILABLE:
                                    case IPBlocksApi.GATEWAY_TIMEOUT:
                                        backoffTime = IPBlocksApi.waitTime;
                                        break;
                                    case IPBlocksApi.TOO_MANY_REQUESTS:
                                        if (response.headers['retry-after'] != null) {
                                            backoffTime = response.headers['retry-after'];
                                        }
                                        else {
     ...
     * @param xContractNumber Users having more than 1 contract need to provide contract number, against which all API requests should be executed
     */
    IPBlocksApi.prototype.ipblocksFindById = function (ipblockId, pretty, depth, xContractNumber, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                // verify required parameter 'ipblockId' is not null or undefined
                if (ipblockId === null || ipblockId === undefined) {
                    throw new Error('Required parameter ipblockId was null or undefined when calling ipblocksFindById.');
                }
                if (pretty !== undefined) {
                    localVarQueryParameters['pretty'] = models_1.ObjectSerializer.serialize(pretty, "boolean");
                }
                ...
                apiCallFunction = function (resolve, reject) {
                    request_1.default(localVarRequestOptions, function (error, response, body) {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "IpBlock");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
     ...
     * @param xContractNumber Users having more than 1 contract need to provide contract number, against which all API requests should be executed
     */
    IPBlocksApi.prototype.ipblocksGet = function (pretty, depth, xContractNumber, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/ipblocks';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
                // give precedence to 'application/json'
                ...
                apiCallFunction = function (resolve, reject) {
                    request_1.default(localVarRequestOptions, function (error, response, body) {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "IpBlocks");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
     ...
     * @param xContractNumber Users having more than 1 contract need to provide contract number, against which all API requests should be executed
     */
    IPBlocksApi.prototype.ipblocksPatch = function (ipblockId, ipblock, pretty, depth, xContractNumber, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                // verify required parameter 'ipblockId' is not null or undefined
                if (ipblockId === null || ipblockId === undefined) {
                    throw new Error('Required parameter ipblockId was null or undefined when calling ipblocksPatch.');
                }
                // verify required parameter 'ipblock' is not null or undefined
                if (ipblock === null || ipblock === undefined) {
                    throw new Error('Required parameter ipblock was null or undefined when calling ipblocksPatch.');
                }
                if (pretty !== undefined) {
                    localVarQueryParameters['pretty'] = models_1.ObjectSerializer.serialize(pretty, "boolean");
                }
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(ipblock, "IpBlockProperties")
                };
                authenticationPromise = Promise.resolve();
                if (this.authentications['Basic Authentication'].username && this.authentications['Basic Authentication'].password) {
                    authenticationPromise = authenticationPromise.then(function () { return _this.authentications['Basic Authentication'].applyToRequest(localVarRequestOptions); });
     ...
     * @param xContractNumber Users having more than 1 contract need to provide contract number, against which all API requests should be executed
     */
    IPBlocksApi.prototype.ipblocksPost = function (ipblock, pretty, depth, xContractNumber, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                // verify required parameter 'ipblock' is not null or undefined
                if (ipblock === null || ipblock === undefined) {
                    throw new Error('Required parameter ipblock was null or undefined when calling ipblocksPost.');
                }
                if (pretty !== undefined) {
                    localVarQueryParameters['pretty'] = models_1.ObjectSerializer.serialize(pretty, "boolean");
                }
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(ipblock, "IpBlock")
                };
                authenticationPromise = Promise.resolve();
                if (this.authentications['Basic Authentication'].username && this.authentications['Basic Authentication'].password) {
                    authenticationPromise = authenticationPromise.then(function () { return _this.authentications['Basic Authentication'].applyToRequest(localVarRequestOptions); });
     ...
     * @param xContractNumber Users having more than 1 contract need to provide contract number, against which all API requests should be executed
     */
    IPBlocksApi.prototype.ipblocksPut = function (ipblockId, ipblock, pretty, depth, xContractNumber, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                // verify required parameter 'ipblockId' is not null or undefined
                if (ipblockId === null || ipblockId === undefined) {
                    throw new Error('Required parameter ipblockId was null or undefined when calling ipblocksPut.');
                }
                // verify required parameter 'ipblock' is not null or undefined
                if (ipblock === null || ipblock === undefined) {
                    throw new Error('Required parameter ipblock was null or undefined when calling ipblocksPut.');
                }
                if (pretty !== undefined) {
                    localVarQueryParameters['pretty'] = models_1.ObjectSerializer.serialize(pretty, "boolean");
                }
    ...
    IPBlocksApi.prototype.sleep = function (seconds) {
        var e = new Date().getTime() + (seconds * 1000);
        while (new Date().getTime() <= e) { }
    };
    IPBlocksApi.prototype.waitForCompletion = function (requestId, timeout, initialWait, scaleup, maxRetries) {
    ...
    IPBlocksApi.BAD_GATEWAY = 502;
    IPBlocksApi.SERVICE_UNAVAILABLE = 503;
    IPBlocksApi.GATEWAY_TIMEOUT = 504;
    IPBlocksApi.TOO_MANY_REQUESTS = 429;
    IPBlocksApi.maxRetries = 3;
    IPBlocksApi.waitTime = 10;
    IPBlocksApi.maxWaitTime = 2000;
    return IPBlocksApi;
}());
