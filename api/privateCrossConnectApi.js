...
exports.PrivateCrossConnectApi = exports.PrivateCrossConnectApiApiKeys = void 0;
...
// ===============================================
var PrivateCrossConnectApiApiKeys;
(function (PrivateCrossConnectApiApiKeys) {
    PrivateCrossConnectApiApiKeys[PrivateCrossConnectApiApiKeys["Token Authentication"] = 0] = "Token Authentication";
})(PrivateCrossConnectApiApiKeys = exports.PrivateCrossConnectApiApiKeys || (exports.PrivateCrossConnectApiApiKeys = {}));
var PrivateCrossConnectApi = /** @class */ (function () {
    function PrivateCrossConnectApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(PrivateCrossConnectApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(PrivateCrossConnectApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(PrivateCrossConnectApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    PrivateCrossConnectApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    PrivateCrossConnectApi.prototype.setApiKey = function (key, value) {
        this.authentications[PrivateCrossConnectApiApiKeys[key]].apiKey = value;
    };
    Object.defineProperty(PrivateCrossConnectApi.prototype, "username", {
    ...
    Object.defineProperty(PrivateCrossConnectApi.prototype, "password", {
    ...
    PrivateCrossConnectApi.prototype.addInterceptor = function (interceptor) {
     ...
     */
    PrivateCrossConnectApi.prototype.pccsDelete = function (pccId, pretty, depth, xContractNumber, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/pccs/{pccId}'
     ...
     * @param xContractNumber Users having more than 1 contract need to provide contract number, against which all API requests should be executed
     */
    PrivateCrossConnectApi.prototype.pccsFindById = function (pccId, pretty, depth, xContractNumber, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
                ...
                apiCallFunction = function (resolve, reject) {
                    request_1.default(localVarRequestOptions, function (error, response, body) {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "PrivateCrossConnect");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
     ...
     * @param xContractNumber Users having more than 1 contract need to provide contract number, against which all API requests should be executed
     */
    PrivateCrossConnectApi.prototype.pccsGet = function (pretty, depth, xContractNumber, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/pccs';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
                // give precedence to 'application/json'
                ...
                apiCallFunction = function (resolve, reject) {
                    request_1.default(localVarRequestOptions, function (error, response, body) {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "PrivateCrossConnects");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
     ...
     * @param xContractNumber Users having more than 1 contract need to provide contract number, against which all API requests should be executed
     */
    PrivateCrossConnectApi.prototype.pccsPatch = function (pccId, pcc, pretty, depth, xContractNumber, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(pcc, "PrivateCrossConnectProperties")
                };
                authenticationPromise = Promise.resolve();
                if (this.authentications['Basic Authentication'].username && this.authentications['Basic Authentication'].password) {
                    authenticationPromise = authenticationPromise.then(function () { return _this.authentications['Basic Authentication'].applyToRequest(localVarRequestOptions); });
     ...
     * @param xContractNumber Users having more than 1 contract need to provide contract number, against which all API requests should be executed
     */
    PrivateCrossConnectApi.prototype.pccsPost = function (pcc, pretty, depth, xContractNumber, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(pcc, "PrivateCrossConnect")
                };
                authenticationPromise = Promise.resolve();
                if (this.authentications['Basic Authentication'].username && this.authentications['Basic Authentication'].password) {
                    authenticationPromise = authenticationPromise.then(function () { return _this.authentications['Basic Authentication'].applyToRequest(localVarRequestOptions); });
    ...
    PrivateCrossConnectApi.prototype.sleep = function (seconds) {
        var e = new Date().getTime() + (seconds * 1000);
        while (new Date().getTime() <= e) { }
    };
    PrivateCrossConnectApi.prototype.waitForCompletion = function (requestId, timeout, initialWait, scaleup, maxRetries) {
    ...
    PrivateCrossConnectApi.BAD_GATEWAY = 502;
    PrivateCrossConnectApi.SERVICE_UNAVAILABLE = 503;
    PrivateCrossConnectApi.GATEWAY_TIMEOUT = 504;
    PrivateCrossConnectApi.TOO_MANY_REQUESTS = 429;
    PrivateCrossConnectApi.maxRetries = 3;
    PrivateCrossConnectApi.waitTime = 10;
    PrivateCrossConnectApi.maxWaitTime = 2000;
    return PrivateCrossConnectApi;
}());
exports.PrivateCrossConnectApi = PrivateCrossConnectApi;
