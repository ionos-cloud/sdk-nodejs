...
export const KubernetesApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} k8sClusterId The unique ID of the Kubernetes Cluster
         * @param {KubernetesNodePool} kubernetesNodePool Details of the Kubernetes Node Pool
         * @param {boolean} [pretty] Controls whether the response is pretty-printed (with indentations and new lines).
         * @param {number} [depth] Controls the detail depth of the response objects.  GET /datacenters/[ID]  - depth&#x3D;0: Only direct properties are included; children (servers and other elements) are not included.  - depth&#x3D;1: Direct properties and children references are included.  - depth&#x3D;2: Direct properties and children properties are included.  - depth&#x3D;3: Direct properties and children properties and children\&#39;s children are included.  - depth&#x3D;... and so on
         * @param {number} [xContractNumber] Users with multiple contracts must provide the contract number, against which all API requests are to be executed.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        k8sNodepoolsPost: async (k8sClusterId: string, kubernetesNodePool: KubernetesNodePool, pretty?: boolean, depth?: number, xContractNumber?: number, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'k8sClusterId' is not null or undefined
            if (k8sClusterId === null || k8sClusterId === undefined) {
         ...
         * @param {string} k8sClusterId The unique ID of the Kubernetes Cluster
         * @param {string} nodepoolId The unique ID of the Kubernetes Node Pool
         * @param {KubernetesNodePoolForPut} kubernetesNodePoolForPut Details of the Kubernetes Node Pool
         * @param {boolean} [pretty] Controls whether the response is pretty-printed (with indentations and new lines).
         * @param {number} [depth] Controls the detail depth of the response objects.  GET /datacenters/[ID]  - depth&#x3D;0: Only direct properties are included; children (servers and other elements) are not included.  - depth&#x3D;1: Direct properties and children references are included.  - depth&#x3D;2: Direct properties and children properties are included.  - depth&#x3D;3: Direct properties and children properties and children\&#39;s children are included.  - depth&#x3D;... and so on
         * @param {number} [xContractNumber] Users with multiple contracts must provide the contract number, against which all API requests are to be executed.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        k8sNodepoolsPut: async (k8sClusterId: string, nodepoolId: string, kubernetesNodePoolForPut: KubernetesNodePoolForPut, pretty?: boolean, depth?: number, xContractNumber?: number, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'k8sClusterId' is not null or undefined
            if (k8sClusterId === null || k8sClusterId === undefined) {
            ...
            // verify required parameter 'kubernetesNodePoolForPut' is not null or undefined
            if (kubernetesNodePoolForPut === null || kubernetesNodePoolForPut === undefined) {
                throw new RequiredError('kubernetesNodePoolForPut','Required parameter kubernetesNodePoolForPut was null or undefined when calling k8sNodepoolsPut.');
            }
            const localVarPath = `/k8s/{k8sClusterId}/nodepools/{nodepoolId}`
                .replace(`{${"k8sClusterId"}}`, encodeURIComponent(String(k8sClusterId)))
                .replace(`{${"nodepoolId"}}`, encodeURIComponent(String(nodepoolId)));
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = {...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers};
            const nonString = typeof kubernetesNodePoolForPut !== 'string';
            const needsSerialization = nonString && configuration && configuration.isJsonMime
                ? configuration.isJsonMime(localVarRequestOptions.headers['Content-Type'])
                : nonString;
            localVarRequestOptions.data =  needsSerialization
                ? JSON.stringify(kubernetesNodePoolForPut !== undefined ? kubernetesNodePoolForPut : {})
         ...
         * @param {string} k8sClusterId The unique ID of the Kubernetes Cluster
         * @param {KubernetesClusterForPut} kubernetesCluster Details of of the Kubernetes Cluster
         * @param {boolean} [pretty] Controls whether the response is pretty-printed (with indentations and new lines).
         * @param {number} [depth] Controls the detail depth of the response objects.  GET /datacenters/[ID]  - depth&#x3D;0: Only direct properties are included; children (servers and other elements) are not included.  - depth&#x3D;1: Direct properties and children references are included.  - depth&#x3D;2: Direct properties and children properties are included.  - depth&#x3D;3: Direct properties and children properties and children\&#39;s children are included.  - depth&#x3D;... and so on
         * @param {number} [xContractNumber] Users with multiple contracts must provide the contract number, against which all API requests are to be executed.
         * @param {*} [options] Override http request option.
...
export const KubernetesApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async k8sNodepoolsPost(k8sClusterId: string, kubernetesNodePool: KubernetesNodePool, pretty?: boolean, depth?: number, xContractNumber?: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<KubernetesNodePool>> {
         ...
         * @throws {RequiredError}
         */
        async k8sNodepoolsPut(k8sClusterId: string, nodepoolId: string, kubernetesNodePoolForPut: KubernetesNodePoolForPut, pretty?: boolean, depth?: number, xContractNumber?: number, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<KubernetesNodePool>> {
            const axiosArgs = await KubernetesApiAxiosParamCreator(configuration).k8sNodepoolsPut(k8sClusterId, nodepoolId, kubernetesNodePoolForPut, pretty, depth, xContractNumber, options);
            return runRequest(axiosArgs, configuration);
        },
        /**
         * This will create a new Kubernetes Cluster.
...
export const KubernetesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        k8sNodepoolsPost(k8sClusterId: string, kubernetesNodePool: KubernetesNodePool, pretty?: boolean, depth?: number, xContractNumber?: number, options?: any): AxiosPromise<KubernetesNodePool> {
         ...
         * @throws {RequiredError}
         */
        k8sNodepoolsPut(k8sClusterId: string, nodepoolId: string, kubernetesNodePoolForPut: KubernetesNodePoolForPut, pretty?: boolean, depth?: number, xContractNumber?: number, options?: any): AxiosPromise<KubernetesNodePool> {
            return KubernetesApiFp(configuration).k8sNodepoolsPut(k8sClusterId, nodepoolId, kubernetesNodePoolForPut, pretty, depth, xContractNumber, options).then((request) => request(axios, basePath));
        },
        /**
         * This will create a new Kubernetes Cluster.
         * @summary Create Kubernetes Cluster
...
export interface KubernetesApiK8sNodepoolsPostRequest {
     ...
     * @memberof KubernetesApiK8sNodepoolsPost
     */
    readonly kubernetesNodePool: KubernetesNodePool
...
export interface KubernetesApiK8sNodepoolsPutRequest {
     ...
     * @memberof KubernetesApiK8sNodepoolsPut
     */
    readonly kubernetesNodePoolForPut: KubernetesNodePoolForPut
...
export interface KubernetesApiK8sPutRequest {
    ...
    /**
     * Details of of the Kubernetes Cluster
...
export class KubernetesApi extends BaseAPI {
    ...
    public k8sNodepoolsPut(requestParameters: KubernetesApiK8sNodepoolsPutRequest, options?: any) {
        return KubernetesApiFp(this.configuration).k8sNodepoolsPut(requestParameters.k8sClusterId, requestParameters.nodepoolId, requestParameters.kubernetesNodePoolForPut, requestParameters.pretty, requestParameters.depth, requestParameters.xContractNumber, options).then((request) => request(this.axios, this.basePath));
    }
