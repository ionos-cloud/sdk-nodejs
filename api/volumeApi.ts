...
export class VolumeApi {
     ...
     */
    public async datacentersVolumesCreateSnapshotPost (datacenterId: string, volumeId: string, pretty?: boolean, depth?: number, xContractNumber?: number, name?: string, description?: string, secAuthProtection?: boolean, licenceType?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Snapshot;  }> {
        const localVarPath = this.basePath + '/datacenters/{datacenterId}/volumes/{volumeId}/create-snapshot'
        ...
        if (secAuthProtection !== undefined) {
            localVarFormParams['secAuthProtection'] = ObjectSerializer.serialize(secAuthProtection, "boolean");
        }

        if (licenceType !== undefined) {
            localVarFormParams['licenceType'] = ObjectSerializer.serialize(licenceType, "string");
        }
        ...
        const apiCallFunction = (resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    ...
                    body = ObjectSerializer.deserialize(body, "Snapshot");
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: Snapshot;  }>(apiCallFunction);
        });
    }
    /**
     ...
     * @param xContractNumber Users having more than 1 contract need to provide contract number, against which all API requests should be executed
     */
    public async datacentersVolumesDelete (datacenterId: string, volumeId: string, pretty?: boolean, depth?: number, xContractNumber?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: object;  }> {
        const localVarPath = this.basePath + '/datacenters/{datacenterId}/volumes/{volumeId}'
            .replace('{' + 'datacenterId' + '}', encodeURIComponent(String(datacenterId)))
            .replace('{' + 'volumeId' + '}', encodeURIComponent(String(volumeId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @param xContractNumber Users having more than 1 contract need to provide contract number, against which all API requests should be executed
     */
    public async datacentersVolumesFindById (datacenterId: string, volumeId: string, pretty?: boolean, depth?: number, xContractNumber?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Volume;  }> {
        const localVarPath = this.basePath + '/datacenters/{datacenterId}/volumes/{volumeId}'
            .replace('{' + 'datacenterId' + '}', encodeURIComponent(String(datacenterId)))
            .replace('{' + 'volumeId' + '}', encodeURIComponent(String(volumeId)));
        let localVarQueryParameters: any = {};
     ...
     */
    public async datacentersVolumesGet (datacenterId: string, pretty?: boolean, depth?: number, xContractNumber?: number, offset?: number, limit?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Volumes;  }> {
        const localVarPath = this.basePath + '/datacenters/{datacenterId}/volumes'
            .replace('{' + 'datacenterId' + '}', encodeURIComponent(String(datacenterId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        const apiCallFunction = (resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    ...
                    body = ObjectSerializer.deserialize(body, "Volumes");
                    if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                        resolve({ response: response, body: body });
                    } else {
                        let backoffTime = 0;
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: Volumes;  }>(apiCallFunction);
        });
    }
    /**
     ...
     * @param xContractNumber Users having more than 1 contract need to provide contract number, against which all API requests should be executed
     */
    public async datacentersVolumesPatch (datacenterId: string, volumeId: string, volume: VolumeProperties, pretty?: boolean, depth?: number, xContractNumber?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Volume;  }> {
        const localVarPath = this.basePath + '/datacenters/{datacenterId}/volumes/{volumeId}'
            .replace('{' + 'datacenterId' + '}', encodeURIComponent(String(datacenterId)))
            .replace('{' + 'volumeId' + '}', encodeURIComponent(String(volumeId)));
        let localVarQueryParameters: any = {};
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(volume, "VolumeProperties")
        };
     ...
     * @param xContractNumber Users having more than 1 contract need to provide contract number, against which all API requests should be executed
     */
    public async datacentersVolumesPost (datacenterId: string, volume: Volume, pretty?: boolean, depth?: number, xContractNumber?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Volume;  }> {
        const localVarPath = this.basePath + '/datacenters/{datacenterId}/volumes'
            .replace('{' + 'datacenterId' + '}', encodeURIComponent(String(datacenterId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @param xContractNumber Users having more than 1 contract need to provide contract number, against which all API requests should be executed
     */
    public async datacentersVolumesPut (datacenterId: string, volumeId: string, volume: Volume, pretty?: boolean, depth?: number, xContractNumber?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Volume;  }> {
        const localVarPath = this.basePath + '/datacenters/{datacenterId}/volumes/{volumeId}'
            .replace('{' + 'datacenterId' + '}', encodeURIComponent(String(datacenterId)))
            .replace('{' + 'volumeId' + '}', encodeURIComponent(String(volumeId)));
        let localVarQueryParameters: any = {};
     ...
     */
    public async datacentersVolumesRestoreSnapshotPost (datacenterId: string, volumeId: string, pretty?: boolean, depth?: number, xContractNumber?: number, snapshotId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: object;  }> {
        const localVarPath = this.basePath + '/datacenters/{datacenterId}/volumes/{volumeId}/restore-snapshot'
            .replace('{' + 'datacenterId' + '}', encodeURIComponent(String(datacenterId)))
            .replace('{' + 'volumeId' + '}', encodeURIComponent(String(volumeId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        if (snapshotId !== undefined) {
            localVarFormParams['snapshotId'] = ObjectSerializer.serialize(snapshotId, "string");
        }
