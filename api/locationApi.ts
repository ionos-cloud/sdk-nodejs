...
export class LocationApi {
     ...
     */
    public async locationsFindByRegionId (regionId: string, pretty?: boolean, depth?: number, xContractNumber?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Locations;  }> {
        const localVarPath = this.basePath + '/locations/{regionId}'
        ...
        const apiCallFunction = (resolve, reject) => {
            localVarRequest(localVarRequestOptions, (error, response, body) => {
                if (error) {
                    ...
                    body = ObjectSerializer.deserialize(body, "Locations");
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: Locations;  }>(apiCallFunction);
        });
    }
    /**
     ...
     * @param xContractNumber Users having more than 1 contract need to provide contract number, against which all API requests should be executed
     */
    public async locationsFindByRegionIdAndId (regionId: string, locationId: string, pretty?: boolean, depth?: number, xContractNumber?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Location;  }> {
        const localVarPath = this.basePath + '/locations/{regionId}/{locationId}'
            .replace('{' + 'regionId' + '}', encodeURIComponent(String(regionId)))
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: Location;  }>(apiCallFunction);
        });
    }
    /**
     ...
     * @param xContractNumber Users having more than 1 contract need to provide contract number, against which all API requests should be executed
     */
    public async locationsGet (pretty?: boolean, depth?: number, xContractNumber?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Locations;  }> {
