...
exports.RequestApi = exports.RequestApiApiKeys = void 0;
...
// ===============================================
var RequestApiApiKeys;
(function (RequestApiApiKeys) {
    RequestApiApiKeys[RequestApiApiKeys["Token Authentication"] = 0] = "Token Authentication";
})(RequestApiApiKeys = exports.RequestApiApiKeys || (exports.RequestApiApiKeys = {}));
var RequestApi = /** @class */ (function () {
    function RequestApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(RequestApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(RequestApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(RequestApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    RequestApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    RequestApi.prototype.setApiKey = function (key, value) {
        this.authentications[RequestApiApiKeys[key]].apiKey = value;
    };
    Object.defineProperty(RequestApi.prototype, "username", {
    ...
    Object.defineProperty(RequestApi.prototype, "password", {
    ...
    RequestApi.prototype.addInterceptor = function (interceptor) {
     ...
     */
    RequestApi.prototype.requestsFindById = function (requestId, pretty, depth, xContractNumber, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/requests/{requestId}'
     ...
     */
    RequestApi.prototype.requestsGet = function (pretty, depth, xContractNumber, filterStatus, filterCreatedAfter, filterCreatedBefore, offset, limit, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/requests';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
                // give precedence to 'application/json'
                ...
                if (filterStatus !== undefined) {
                    localVarQueryParameters['filter.status'] = models_1.ObjectSerializer.serialize(filterStatus, "string");
                }
                if (filterCreatedAfter !== undefined) {
                    localVarQueryParameters['filter.createdAfter'] = models_1.ObjectSerializer.serialize(filterCreatedAfter, "string");
                }
                if (filterCreatedBefore !== undefined) {
                    localVarQueryParameters['filter.createdBefore'] = models_1.ObjectSerializer.serialize(filterCreatedBefore, "string");
                }
                if (offset !== undefined) {
                ...
                apiCallFunction = function (resolve, reject) {
                    request_1.default(localVarRequestOptions, function (error, response, body) {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "Requests");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
     ...
     * @param xContractNumber Users having more than 1 contract need to provide contract number, against which all API requests should be executed
     */
    RequestApi.prototype.requestsStatusGet = function (requestId, pretty, depth, xContractNumber, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/requests/{requestId}/status'
                    .replace('{' + 'requestId' + '}', encodeURIComponent(String(requestId)));
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
                ...
                apiCallFunction = function (resolve, reject) {
                    request_1.default(localVarRequestOptions, function (error, response, body) {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "RequestStatus");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
    ...
    RequestApi.prototype.sleep = function (seconds) {
        var e = new Date().getTime() + (seconds * 1000);
        while (new Date().getTime() <= e) { }
    };
    RequestApi.prototype.waitForCompletion = function (requestId, timeout, initialWait, scaleup, maxRetries) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        requestCall = (new RequestApi(this.username, this.password)).requestsStatusGet(requestId);
                        breakLoop = false;
                        _a.label = 1;
                    case 1:
    ...
    RequestApi.BAD_GATEWAY = 502;
    RequestApi.SERVICE_UNAVAILABLE = 503;
    RequestApi.GATEWAY_TIMEOUT = 504;
    RequestApi.TOO_MANY_REQUESTS = 429;
    RequestApi.maxRetries = 3;
    RequestApi.waitTime = 10;
    RequestApi.maxWaitTime = 2000;
    return RequestApi;
}());
