...
exports.DataCenterApi = exports.DataCenterApiApiKeys = void 0;
...
// ===============================================
var DataCenterApiApiKeys;
(function (DataCenterApiApiKeys) {
    DataCenterApiApiKeys[DataCenterApiApiKeys["Token Authentication"] = 0] = "Token Authentication";
})(DataCenterApiApiKeys = exports.DataCenterApiApiKeys || (exports.DataCenterApiApiKeys = {}));
var DataCenterApi = /** @class */ (function () {
    function DataCenterApi(basePathOrUsername, password, basePath) {
    ...
    Object.defineProperty(DataCenterApi.prototype, "useQuerystring", {
        set: function (value) {
    ...
    Object.defineProperty(DataCenterApi.prototype, "basePath", {
        get: function () {
    ...
    Object.defineProperty(DataCenterApi.prototype, "defaultHeaders", {
        get: function () {
    ...
    DataCenterApi.prototype.setDefaultAuthentication = function (auth) {
        this.authentications.default = auth;
    };
    DataCenterApi.prototype.setApiKey = function (key, value) {
        this.authentications[DataCenterApiApiKeys[key]].apiKey = value;
    };
    Object.defineProperty(DataCenterApi.prototype, "username", {
    ...
    Object.defineProperty(DataCenterApi.prototype, "password", {
    ...
    DataCenterApi.prototype.addInterceptor = function (interceptor) {
     ...
     */
    DataCenterApi.prototype.datacentersDelete = function (datacenterId, pretty, depth, xContractNumber, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/datacenters/{datacenterId}'
     ...
     * @param xContractNumber Users having more than 1 contract need to provide contract number, against which all API requests should be executed
     */
    DataCenterApi.prototype.datacentersFindById = function (datacenterId, pretty, depth, xContractNumber, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
                ...
                apiCallFunction = function (resolve, reject) {
                    request_1.default(localVarRequestOptions, function (error, response, body) {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "Datacenter");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
     ...
     */
    DataCenterApi.prototype.datacentersGet = function (pretty, depth, xContractNumber, offset, limit, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            var _this = this;
            return __generator(this, function (_b) {
                localVarPath = this.basePath + '/datacenters';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this._defaultHeaders);
                produces = ['application/json'];
                // give precedence to 'application/json'
                ...
                apiCallFunction = function (resolve, reject) {
                    request_1.default(localVarRequestOptions, function (error, response, body) {
                        if (error) {
                            ...
                            body = models_1.ObjectSerializer.deserialize(body, "Datacenters");
                            if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                                resolve({ response: response, body: body });
                            }
                            else {
     ...
     * @param xContractNumber Users having more than 1 contract need to provide contract number, against which all API requests should be executed
     */
    DataCenterApi.prototype.datacentersPatch = function (datacenterId, datacenter, pretty, depth, xContractNumber, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(datacenter, "DatacenterProperties")
                };
                authenticationPromise = Promise.resolve();
                if (this.authentications['Basic Authentication'].username && this.authentications['Basic Authentication'].password) {
                    authenticationPromise = authenticationPromise.then(function () { return _this.authentications['Basic Authentication'].applyToRequest(localVarRequestOptions); });
     ...
     * @param xContractNumber Users having more than 1 contract need to provide contract number, against which all API requests should be executed
     */
    DataCenterApi.prototype.datacentersPost = function (datacenter, pretty, depth, xContractNumber, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                localVarRequestOptions = {
                    ...
                    useQuerystring: this._useQuerystring,
                    json: true,
                    body: models_1.ObjectSerializer.serialize(datacenter, "Datacenter")
                };
                authenticationPromise = Promise.resolve();
                if (this.authentications['Basic Authentication'].username && this.authentications['Basic Authentication'].password) {
                    authenticationPromise = authenticationPromise.then(function () { return _this.authentications['Basic Authentication'].applyToRequest(localVarRequestOptions); });
     ...
     * @param xContractNumber Users having more than 1 contract need to provide contract number, against which all API requests should be executed
     */
    DataCenterApi.prototype.datacentersPut = function (datacenterId, datacenter, pretty, depth, xContractNumber, options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
    ...
    DataCenterApi.prototype.sleep = function (seconds) {
        var e = new Date().getTime() + (seconds * 1000);
        while (new Date().getTime() <= e) { }
    };
    DataCenterApi.prototype.waitForCompletion = function (requestId, timeout, initialWait, scaleup, maxRetries) {
    ...
    DataCenterApi.BAD_GATEWAY = 502;
    DataCenterApi.SERVICE_UNAVAILABLE = 503;
    DataCenterApi.GATEWAY_TIMEOUT = 504;
    DataCenterApi.TOO_MANY_REQUESTS = 429;
    DataCenterApi.maxRetries = 3;
    DataCenterApi.waitTime = 10;
    DataCenterApi.maxWaitTime = 2000;
    return DataCenterApi;
}());
exports.DataCenterApi = DataCenterApi;
