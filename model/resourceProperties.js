...
var ResourceProperties = /** @class */ (function () {
    function ResourceProperties() {
    }
    ResourceProperties.getAttributeTypeMap = function () {
        return ResourceProperties.attributeTypeMap;
    };
    ResourceProperties.discriminator = undefined;
    ResourceProperties.attributeTypeMap = [
        {
            "name": "name",
            "baseName": "name",
            "type": "string"
