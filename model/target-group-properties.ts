...
export interface TargetGroupProperties {
     ...
     * @memberof TargetGroupProperties
     */
    protocolVersion?: TargetGroupPropertiesProtocolVersionEnum;
...
/**
    ...
    * @enum {string}
    */
export enum TargetGroupPropertiesAlgorithmEnum {
...
/**
    ...
    * @enum {string}
    */
export enum TargetGroupPropertiesProtocolVersionEnum {
    Http1 = 'HTTP1',
    Http2 = 'HTTP2'
}
